...
$discography = [
    ...
    [
        ...
        "status" => ["USA" => "Платиновый", "GBR" => "Платиновый", "CAN" => "Бриллиантовый"]
    ],
    [
        "id" => "5",
        ...
        "status" => ["USA" => "Платиновый", "GBR" => "Золотой", "CAN" => "Платиновый"]
    ],
    [
        "id" => "6",
        "name" => "Animals",
    ...
    [
        ...
        "label" => ["Harvest", "EMI", "Columbia", "Capitol"],
        "format" => ["LP", "8-track", "Кассета", "CD"],
        "status" => ["USA" => "Платиновый", "GBR" => "Платиновый", "CAN" => "Бриллиантовый", "NLD" => "Платиновый"]
    ],
    [
        "id" => "8",
        "name" => "The Final Cut",
        ...
        "label" => ["Harvest", "EMI", "Columbia", "Capitol"],
        "format" => ["LP", "8-track", "Кассета", "CD"],
        "status" => ["USA" => "Платиновый", "GBR" => "Золотой", "NLD" => "Золотой"]
    ],
    [
        "id" => "9",
        ...
        "label" => ["EMI", "Columbia"],
        "format" => ["LP", "Кассета", "CD"],
        "status" => ["USA" => "Платиновый", "GBR" => "Золотой", "CAN" => "Платиновый", "NLD" => "Золотой"]
    ],
    [
        "id" => "10",
        ...
        "label" => ["EMI", "Columbia"],
        "format" => ["LP", "Кассета", "CD"],
        "status" => ["USA" => "Платиновый", "GBR" => "Платиновый", "CAN" => "Платиновый", "NLD" => "Платиновый"]
    ]
];
